...
## [0.3.0](https://github.com/Paaaddy/DALY-USB/compare/v0.2.3...v0.3.0) (2026-05-23)
...
* hardware safety hardening ([29529bf](https://github.com/Paaaddy/DALY-USB/commit/29529bf4b31744dfcd93aa78f31ba3460f32cf29))
* hardware safety hardening from autoplan security review ([c4b95e1](https://github.com/Paaaddy/DALY-USB/commit/c4b95e161d242eddf9de8dc5757cf5a0f8fd43c3))
...
* add prepare script so git installs compile TypeScript ([d010719](https://github.com/Paaaddy/DALY-USB/commit/d010719ae14935cb866a5494ceba8e52c18fe9f6))
* add prepare script so git installs compile TypeScript ([88b1f1e](https://github.com/Paaaddy/DALY-USB/commit/88b1f1e4ccb91a458fd94e002840787d66916a25))
* close hardware safety gaps in MOSFET write path ([0015699](https://github.com/Paaaddy/DALY-USB/commit/0015699e884f649a2640fb0441d1f2217b86cb94))
* commit build output so git installs work on npm 10 ([d9e43eb](https://github.com/Paaaddy/DALY-USB/commit/d9e43eb706201e7e3cc2532fc8287b945c9381a3))
* commit build output so git installs work on npm 10 ([f3c1804](https://github.com/Paaaddy/DALY-USB/commit/f3c1804500f18e6363af2c6bb5d54838ed9b29a1))
* derive pack voltage ceiling from discovered cell count ([5f09040](https://github.com/Paaaddy/DALY-USB/commit/5f0904007a2c298b43120e8bdc7d024afa5a828b))
* document two-arg install command and add missing news entries ([41c78c6](https://github.com/Paaaddy/DALY-USB/commit/41c78c674bbc69703df34db2ab97a6b2e7eeaded))
* harden adapter for production reliability ([2dbdd12](https://github.com/Paaaddy/DALY-USB/commit/2dbdd122b0fd439d6a342d2ab229a62cb0ce758c))
* hardware safety hardening + production reliability ([0d596d7](https://github.com/Paaaddy/DALY-USB/commit/0d596d76381dc5ad01e5811ea2894cb87e1115a2))
* null all volatile telemetry on connection loss to prevent stale-data hazards ([42a143d](https://github.com/Paaaddy/DALY-USB/commit/42a143d545cdd587e56bf2a55998f5ae06fc0301))
* remove prepare script so git installs use committed build output ([8acc148](https://github.com/Paaaddy/DALY-USB/commit/8acc1489a351d395af3a969aade44ab7995641c3))
* remove prepare script so git installs use committed build output ([48ce5b0](https://github.com/Paaaddy/DALY-USB/commit/48ce5b077f15cb3e4bb65be9d4015e7fd8855bee))
